...
@section('title', 'Preguntas Frecuentes | Gesccol')
    
@section('content')

<header class="container-xl">
    <x-header-bar>
        <h1 class=" text-5xl font-bold text-[#2299AA] m-auto text-center">Preguntas Frecuentes</h1>
    </x-header-bar>
</header>
{{-- preguntas frecuentes  --}}
<div class="container m-auto md:p-5 my-6">
    <div x-data="{ openedIndex: 1 }" class="flex flex-col p-4">
        ...
        <div @click="openedIndex == 1 ? openedIndex = -1 : openedIndex = 1" class="mb-5 flex items-center bg-white border-t border-b border-secondary p-4">
          <p class="text-xl">¿Ques es gestion catastral?</p>
