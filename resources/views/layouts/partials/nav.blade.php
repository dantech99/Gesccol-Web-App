...
<div class="w-full text-gray-700 bg-[#3366CC] shadow dark-mode:text-gray-200">
  <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
    ...
    <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-center md:flex-row text-base">
      ...
      <a class="{{request()->routeIs('posts.index') ? 'active' : ''}}  px-4 py-4 mt-2  font-semibold text-white md:mt-0 hover:text-black focus:text-gray-900 hover:bg-[#85a133] focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="{{Route('posts.index')}}">Noticias Y Comunicado</a>
      ...
      <a class="{{request()->routeIs('home.somos') ? 'active' : ''}} px-4 py-4 mt-2  font-semibold text-white md:mt-0 hover:text-black focus:text-gray-900 hover:bg-[#85a133] focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="{{Route('home.somos')}}">Quienes Somos</a>
      ...
      <div @click.away="open = false" class="relative" x-data="{ open: false }">
        ...
        <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 w-full  origin-top-right rounded-md shadow-lg md:w-48 z-50">
          <div class="px-2 py-2 bg-[#3366CC]  shadow text-white text-base">
            <a class="block px-4 py-4 mt-2 font-semibold bg-transparent rounded-lg md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-[#85a133] focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">Notificaciones</a>

            <a class="block px-4 py-4 mt-2 font-semibold bg-transparent rounded-lg md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-[#85a133] focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">Informacion</a>
